...
void RoutePlanner::AddNeighbors(RouteModel::Node* current_node) {
    ...
    for (RouteModel::Node* temp_node : current_node->neighbors) {
        ...
        temp_node->h_value = this->CalculateHValue(temp_node);
        temp_node->g_value = current_node->g_value + current_node->distance(*temp_node);
...
RouteModel::Node* RoutePlanner::NextNode() {
    sort(open_list.begin(), open_list.end(), [&](const auto& i, const auto& j) {return i->g_value + i->h_value > j->g_value + j->h_value; });
